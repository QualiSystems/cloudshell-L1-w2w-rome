...
class TestMain(TestCase):
    ...
    def test_run_driver(
        self,
        driver_listener_class,
        command_executor_class,
        get_qs_logger_mod,
        xml_logger_class,
        ...
        join_calls = [
            call(self._driver_path, driver_name + "_" + "RuntimeConfig.yml"),
        ...
        get_qs_logger_mod.assert_called_once_with(
        ...
        command_executor_class.assert_called_once_with(
            driver_commands_inst, command_logger
        )
        driver_listener_class.assert_called_once_with(
            command_executor_inst, xml_logger_inst, command_logger
        )
